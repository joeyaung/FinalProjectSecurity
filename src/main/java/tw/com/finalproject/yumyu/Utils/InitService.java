...
//		Create default Center
		...
		Center defaultCenter1 = Center.builder().centerName("內湖展示中心").centerPhone("02-27939191").centerEmail("NeihuCenter@gmail.com").centerLoc("台北市").centerLocSit("內湖區").centerAddress("台北市內湖區新湖三路288號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteNeihu).latitude("25.066693320651687").longitude("121.58241079480605").build();
		...
		Center defaultCenter2 = Center.builder().centerName("大安展示中心").centerPhone("02-82443207").centerEmail("DaanCenter@gmail.com").centerLoc("台北市").centerLocSit("大安區").centerAddress("台北市大安區四維路208巷10號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteDaan).latitude("25.026287234825105").longitude("121.5474338543234").build();
		...
		Center defaultCenter3 = Center.builder().centerName("信義展示中心").centerPhone("02-67360223").centerEmail("XinyiCenter@gmail.com").centerLoc("台北市").centerLocSit("信義區").centerAddress("台北市信義區松智路1號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteXinyi).latitude("25.0388559895188").longitude("121.56627022548838").build();
		...
		Center defaultCenter4 = Center.builder().centerName("板橋展示中心").centerPhone("02-59242558").centerEmail("BanqiaoCenter@gmail.com").centerLoc("新北市").centerLocSit("板橋區").centerAddress("新北市板橋區新府路30號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteBanqiao).latitude("25.011155993514862").longitude("121.46503899665238").build();
		...
		Center defaultCenter5 = Center.builder().centerName("中和展示中心").centerPhone("02-87823688").centerEmail("ZhongheCenter@gmail.com").centerLoc("新北市").centerLocSit("中和區").centerAddress("新北市中和區建八路63號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteZhonghe).latitude("24.999313397163245").longitude("121.48750046966435").build();
		...
		Center defaultCenter6 = Center.builder().centerName("平鎮展示中心").centerPhone("03-4158259").centerEmail("PingzhenCenter@gmail.com").centerLoc("桃園市").centerLocSit("平鎮區").centerAddress("桃園市平鎮區南豐路2號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(bytePingzhen).latitude("24.900391473028883").longitude("121.21014419664988").build();
		...
		Center defaultCenter7 = Center.builder().centerName("桃園展示中心").centerPhone("03-3394095").centerEmail("TaoyuanCenter@gmail.com").centerLoc("桃園市").centerLocSit("桃園區").centerAddress("桃園市桃園區樹仁三街28號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteTaoyuan).latitude("24.974947886449666").longitude("121.32264789665159").build();
		...
		Center defaultCenter8 = Center.builder().centerName("北屯展示中心").centerPhone("04-94698572").centerEmail("BeitunCenter@gmail.com").centerLoc("台中市").centerLocSit("北屯區").centerAddress("台中市北屯區山西路29號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteBeitun).latitude("24.16925613777969").longitude("120.67552299663411").build();
		...
		Center defaultCenter9 = Center.builder().centerName("南屯展示中心").centerPhone("04-91549841").centerEmail("NantunCenter@gmail.com").centerLoc("台中市").centerLocSit("南屯區").centerAddress("台中市南屯區精科中路18號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteNantun).latitude("24.149299332609868").longitude("120.59763739663363").build();
		...
		Center defaultCenter10 = Center.builder().centerName("安平展示中心").centerPhone("06-2059627").centerEmail("AnpingCenter@gmail.com").centerLoc("台南市").centerLocSit("安平區").centerAddress("台南市安平區文平路9號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteAnping).latitude("22.983811502039387").longitude("120.17736598311556").build();
		...
		Center defaultCenter11 = Center.builder().centerName("永康展示中心").centerPhone("06-6915174").centerEmail("YongkangCenter@gmail.com").centerLoc("台南市").centerLocSit("永康區").centerAddress("台南市永康區廣興街33號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteYongkang).latitude("23.01922608496213").longitude("120.27650034078707").build();
		...
		Center defaultCenter12 = Center.builder().centerName("左營展示中心").centerPhone("07-8344778").centerEmail("ZuoyingCenter@gmail.com").centerLoc("高雄市").centerLocSit("左營區").centerAddress("高雄市左營區新莊一路306號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteZuoying).latitude("22.670738986446395").longitude("120.3008856407799").build();
		...
		Center defaultCenter13 = Center.builder().centerName("鼓山展示中心").centerPhone("07-8015406").centerEmail("GushanCenter@gmail.com").centerLoc("高雄市").centerLocSit("鼓山區").centerAddress("高雄市鼓山區龍水一街21號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteGushan).latitude("22.648716879310285").longitude("120.28309893523691").build();
		...
		Center defaultCenter14 = Center.builder().centerName("五結展示中心").centerPhone("03-9571691").centerEmail("WujieCenter@gmail.com").centerLoc("宜蘭縣").centerLocSit("五結鄉").centerAddress("宜蘭縣五結鄉三吉中路34號").centerOpentime("週一至週日 09:00 - 21:00").centerImage(byteWujie).latitude("24.70818759094591").longitude("121.79173311568226").build();
