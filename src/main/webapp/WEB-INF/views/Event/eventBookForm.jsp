				...
				<div class="row gx-4 gx-lg-5 justify-content-center">
					<div class="col-lg-10 po-re">
									...
									<tbody>
											...
											<td>
												<div class="form-group">
													...
													<input class="form-control" type="text"
														aria-label="default input example" name="name" maxlength="10"
														id="name" placeholder="請輸入姓名" required>
											...
											<td>
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="radio" name="gender"
														id="flexRadioDefault1" value="先生" /> <label
														class="form-check-label" for="flexRadioDefault1"></label>
													先生 </label>
												</div>
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="radio" name="gender"
														id="flexRadioDefault2" value="小姐" checked /> <label
														class="form-check-label" for="flexRadioDefault2">
														小姐 </label>
												</div>
												<div class="form-check form-check-inline">
													<input class="form-check-input" type="radio" name="gender"
														id="flexRadioDefault3" value="其他" checked /> <label
										...
										<tr>
											...
											<td>
												<div class="form-group">
													...
													<input class="form-control" type="text"
														aria-label="default input example" name="id_number"
										...
										<tr>
											...
											<td><input class="form-control" type="text"
													aria-label="default input example" name="phone" maxlength="13"
													id="phone" placeholder="請輸入連絡電話" required />
						...
						<tr>
							...
							<td><input class="form-control" type="email" aria-label="default input example" name="email"
									maxlength="35" id="email" placeholder="請輸入電子信箱" required />
					...
					<tr>
						...
						<td><textarea class="form-control" id="message" rows="5" cols="30" name="message"
								placeholder="備註200字以內" style="height: 88px;"></textarea></td>
					</tr>
					...
					$("#idnumber").blur(
						function () {
							...
							if (id == '') {
								...
								$("#idnumber").removeClass(
									"form-control is-invalid");
								$("#validationServer02Feedback")
									.val('');
								$("#idnumber").addClass(
									"form-control is-valid");
