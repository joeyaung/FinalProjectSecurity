					...
					<div id='container'>
						<form id="event_form">
							<table class="table_bookf">
								<tbody>
										...
										<td>
											<div class="form-group">
												...
												<div id="validationServer02Feedback"
													class="invalid-feedback">姓名欄位不可為空白</div>
										...
										<td>
											<div class="form-group">
												...
												<input class="form-control" type="text"
													...
													maxlength="10" id="idnumber" placeholder="請輸入身分證字號"
													required>
									...
									<tr>
										...
										<td><textarea class="form-control" id="message" rows="5"
												cols="30" name="message" placeholder="備註200字以內"
												style="height: 88px;"></textarea></td>
									</tr>
							...
							<div class="div" style="text-align: center;">
								...
								<button type="button" class="btn btn-primary wh-40"
									id="submitid">送出</button>
								<input type="button" id="shortcut"
									class="btn btn-secondary wh-40 onekey" value="一鍵輸入">
							</div>
