    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item"><a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
            aria-expanded="true" aria-controls="collapseTwo"> <i class="fas fa-users"></i> <span>Client</span>
          </a>
        ...
        <!-- Nav Item - 試駕總覽 -->
        <li class="nav-item"><a class="nav-link" href="/FinalProject/admin/edit/testdrive"> <i class="fas fa-car"></i>
            <span>試駕總覽</span></a></li>
          ...
          <nav class="
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow"><a class="nav-link dropdown-toggle" href="#" id="userDropdown"
                  ...
                  <img class="img-profile rounded-circle" src="/FinalProject/images/svg/undraw_profile.svg" />
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          attendLimit = data;
          localStorage.setItem("attendLimit", attendLimit);
        },
        error: function (err) {
          alert(err);
        }
      ...
      //取得已報名人數Array
      var retrievedData = localStorage.getItem("registeredNumber");
      var str = JSON.stringify(retrievedData);
      var strJson = JSON.parse(str);
      var regisArray = strJson.split(",");

      var retrievedData1 = localStorage.getItem("attendLimit");
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['#活動 1', '#活動 2', '#活動 3', '#活動 4', '#活動 5'],
          datasets: [{
            label: '# 各活動報名人數統計表',
            data: regisArray,
