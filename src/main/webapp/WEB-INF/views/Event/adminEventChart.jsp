            ...
            ">
              ...
              ">
                ...
                <canvas class="myChart" id="myChart"></canvas>
                      ...
                      ">
										<h6 class="m-0 font-weight-bold text-primary">活動#1 報名男女比
										</h6>
									...
									<div class="card-body d-flex flex-column">
										<div class="chart-pie pt-4 pb-2">
											<canvas class="myChart" id="myChart0"></canvas>
										</div>
                          ...
                          justify-content-between
                        ">
										<h6 class="m-0 font-weight-bold text-primary">活動#2 報名男女比
										</h6>
                            ...
                            justify-content-between
                          ">
										<h6 class="m-0 font-weight-bold text-primary">活動#3 報名男女比
										</h6>
						...
						<div class="row">
                            ...
                            justify-content-between
                          ">
										<h6 class="m-0 font-weight-bold text-primary">活動#4 報名男女比
										</h6>
                            ...
                            justify-content-between
                          ">
										<h6 class="m-0 font-weight-bold text-primary">活動#5 報名男女比
										</h6>
					...
					function() {
						...
						$.ajax({
							...
							success : function(response) {
								...
								localStorage.setItem("registeredNumber",
										registeredNumber);
						...
						$.ajax({
							...
							success : function(data) {
								attendLimit = data;
								localStorage
										.setItem("attendLimit", attendLimit);
							},
							error : function(err) {
								alert(err);
							}
						...
						//取得已報名人數Array
						var retrievedData = localStorage
								.getItem("registeredNumber");
						var str = JSON.stringify(retrievedData);
						var strJson = JSON.parse(str);
						var regisArray = strJson.split(",");

						var retrievedData1 = localStorage
								.getItem("attendLimit");
						var str1 = JSON.stringify(retrievedData1);
						var strJson1 = JSON.parse(str1);
						var limitArray = strJson1.split(",");
						...
						//取得各活動男性報名人數Array
						var retrievedData2 = localStorage.getItem("manCount");
						var str2 = JSON.stringify(retrievedData2);
						var str2Json = JSON.parse(str2);
						var manCountArray = str2Json.split(",");

						var retrievedData3 = localStorage.getItem("womanCount");
						var str3 = JSON.stringify(retrievedData3);
						var strJson3 = JSON.parse(str3);
						var womanCountArray = strJson3.split(",");
						...
						var genderRatioArray0 = new Array(womanCountArray[0],
								manCountArray[0]);
						...
						var genderRatioArray1 = new Array(womanCountArray[1],
								manCountArray[1]);
						...
						var genderRatioArray2 = new Array(womanCountArray[2],
								manCountArray[2]);
						...
						var genderRatioArray3 = new Array(womanCountArray[3],
								manCountArray[3]);
						...
						var genderRatioArray4 = new Array(womanCountArray[4],
								manCountArray[4]);
