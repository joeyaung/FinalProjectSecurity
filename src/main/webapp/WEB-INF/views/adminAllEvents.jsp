<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>編輯活動列表 Events Dashboard</title>
                ...
                ">
                  ...
                  ">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">編輯活動 Events Dashboard</h1>
                        <p class="mb-4">活動編輯 Modify Events</p>
                        ...
                        可放表格, 圖表, 要填的 form 之類的~ -->
                            <!-- this is button -->
                            <button id="addEventBtn" type="submit" class="btn btn-primary">Add
                                Event</button>
                            <!-- this is datables -->
