									...
									<form id="form1">
										...
										<table class="box">
											<tr>
												<td>標題
											<tr>
												<td><input class="myitem" id="title" type="text"
													name="title" value="${news.title}" style="width: 500px"><br />
													<span id="sp1" style="width: 10px" class="add_span"></span>
													<img src=""></td>
											<tr>
												<td>副標題
											<tr>
												<td><input class="myitem" id="subtitle" type="text"
													name="subtitle" value="${news.subtitle}"
													style="width: 500px"><br /> <span id="sp2"
													style="width: 10px" class="add_span"></span> <img src=""></td>
											<tr>
												<td>
											<tr>
											...
											<tr>
												<td><input id="remarks" name="remarks"
													value="${news.remarks}" style="width: 500px"></td>
											<tr>
										</table>
									...
									<form id="edit_form">
										...
										<table class="box">
											...
											<tr>
												...
												<td><input class="myitem" id="edit_title" type="text"
													name="title" style="width: 500px"><br /> <span
													id="sp1" style="width: 10px"></span> <img src=""></td>
											<tr>
												<td>副標題
											<tr>
												<td><input class="myitem" id="edit_subtitle"
													type="text" name="subtitle" style="width: 500px"><br />
													<span id="sp2" style="width: 10px"></span> <img src="">
												</td>
											<tr>
												<td>上傳日期
											<tr>
												<td><input class="myitem" id="edit_uploaddate"
													type="date" name="uploadDate" /> <br /> <span id="sp3"
											...
											<tr>
												<td>
											<tr>
												<td><input id="edit_remarks" name="remarks"
													value="${news.remarks}" style="width: 500px"></td>
											<tr>
										</table>
									</form>
